...
namespace Pdd.Sdk.Apis
{
    ...
    /// </summary>
    public class PddDdkOrderDetailGetRequest : PddBaseRequest
    {
        protected override string Type => "pdd.ddk.order.detail.get";

        public PddDdkOrderDetailGetRequest() { }

        public PddDdkOrderDetailGetRequest(string clientId, string clientSecret) : base(clientId, clientSecret) { }

        public async Task<PddDdkOrderDetailGetResponse> InvokeAsync()
            => await PostAsync<PddDdkOrderDetailGetResponse>();
        /// <summary>
        /// 必填
        /// 订单号
        /// </summary>
    ...
    /// 查询订单详情
    /// </summary>
    public class PddDdkOrderDetailGetResponse : PddBaseResponse
    {
        /// <summary>
        /// order_detail_response
        /// </summary>
        [JsonProperty("order_detail_response")]
        public PddDdkOrderDetailGet_OrderDetailResponse OrderDetailResponse { get; set; }
    }

    /// <summary>
    /// order_detail_response
    /// </summary>
    public class PddDdkOrderDetailGet_OrderDetailResponse
    {
        /// <summary>
        /// 订单编号
        /// </summary>
